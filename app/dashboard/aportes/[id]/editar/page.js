// app/dashboard/aportes/[id]/editar/page.js
"use client";
...
export default function EditarAportePage() {
  ...
  useEffect(() => {
    ...
    if (!stored) {
      toast.error("No se encontraron datos del aporte.");
      ...
      const response = await apiFetch(
        `/aportes/${id}/update/t/${selectedStore.tienda.id}/`,
        {
          ...
          body: JSON.stringify({
            ...
            trabajador: aporte.trabajador.id,
  ...
  if (!aporte) return <LoadingSpinner />;
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-0">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="min-w-0">
            <h1 className="text-xl font-black text-slate-800 dark:text-white tracking-tight uppercase truncate">Ajustar Aporte</h1>
            <p className="text-[10px] font-black text-indigo-500 uppercase tracking-widest leading-none mt-1">
              Rectificación • <span className="opacity-60">{aporte.trabajador.trabajador}</span>
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="relative z-10">
                <form onSubmit={handleSubmit} className="space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {/* Inversionista — bloqueado */}
                    <div className="md:col-span-2 space-y-3">
                      <div className="flex items-center gap-2 px-1">
                        <FiUser size={14} className="text-indigo-500" />
                        <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Inversionista (Inamovible)</span>
                      </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <input
                        ...
                        required
                        className="w-full px-5 py-3.5 bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700 rounded-2xl text-[13px] font-black text-slate-800 dark:text-white focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all outline-none"
                      />
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="relative group">
                        ...
                        <input
                          ...
                          className="w-full pl-16 pr-6 py-5 bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700 rounded-2xl text-[24px] font-black text-slate-800 dark:text-white focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all outline-none"
                        />
                      </div>
                    </div>
                    ...
                    <div className="md:col-span-2 space-y-3">
                      ...
                      <textarea
                        ...
                        className="w-full px-5 py-4 bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700 rounded-2xl text-[13px] font-bold text-slate-800 dark:text-white focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all outline-none resize-none placeholder:text-slate-400"
                      />
                    </div>
                  </div>
                  ...
                  <div className="fixed bottom-0 left-0 w-full p-4 bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl border-t border-slate-200 dark:border-slate-800 z-[100] md:relative md:bottom-auto md:bg-transparent md:border-t-0 md:p-0 md:backdrop-blur-none md:z-auto">
                    <div className="flex flex-col md:flex-row items-center justify-end gap-3 max-w-7xl mx-auto">
                      <button
                        ...
                        className="w-full md:flex-1 py-4.5 bg-slate-900 dark:bg-indigo-600 text-white rounded-2xl font-black text-[11px] uppercase tracking-widest flex items-center justify-center gap-3 active:scale-95 transition-all shadow-xl shadow-slate-200 dark:shadow-none disabled:opacity-50 order-1 md:order-2"
                      >
                        {isSubmitting ? (
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="glass p-5 md:p-8 rounded-[1.5rem] md:rounded-[2rem] border-white/60 dark:border-slate-800 overflow-hidden relative">
              <div className="relative z-10 space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <h2 className="text-sm font-black text-slate-800 dark:text-white uppercase tracking-tight">Impacto al Capital</h2>
                </div>
                <div className="bg-slate-900 dark:bg-slate-800/50 rounded-2xl p-6">
                  <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Nuevo Valor</p>
                ...
                <div className="flex items-start gap-3 opacity-60">
                  ...
                  <p className="text-[8px] font-bold text-slate-400 uppercase tracking-widest leading-relaxed">
                    El ajuste recalibra el capital operativo. Verifique antes de confirmar.
                  </p>
                </div>
              </div>
            </div>
